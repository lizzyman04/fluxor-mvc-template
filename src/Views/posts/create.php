        ...
        <div class="bg-white rounded-lg shadow p-8">
            ...
            <form id="createPostForm" class="space-y-4">
                ...
                <div class="flex justify-end space-x-3">
                    <a href="/posts" class="bg-gray-300 text-gray-800 px-4 py-2 rounded-lg hover:bg-gray-400">Cancel</a>
                    <button type="submit"
                        class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700">Create</button>
                </div>
            </form>
        </div>
    </div>
